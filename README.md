...
| 📉 K 線頁面 | 點擊任一代號（Cards、盤前卡片、P&L 表格代號欄）進入 K 線；開盤中預設「盤中」tab（X 軸固定 US 9:30–16:00 ET / TW 9:00–13:30），盤外（盤前/後/休市）預設「1 日」tab（X 軸為過去 24 小時滾動視窗）；1日~5日 tab 皆標示盤中時間段；30 秒自動重整 + 手動重整按鈕 |
